...
import temporalDifferenceGridworld from './projects/temporal-difference-gridworld.js'
...
const projects = [multica, symphony, okf, openaiAgentsPython, pi, mcp, superpowersOpenspec, langgraph, embodiedAi, vla, rag, embeddingsRerankers, bellmanGridworld, monteCarloGridworld, temporalDifferenceGridworld, findingCodeToChange, dddAnd3a, mineru, llamaCpp].sort((a, b) => b.date.localeCompare(a.date))
