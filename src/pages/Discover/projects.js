...
import stochasticApproxSgd from './projects/stochastic-approx-sgd.js'
...
const projects = [multica, symphony, okf, openaiAgentsPython, pi, mcp, superpowersOpenspec, langgraph, embodiedAi, vla, rag, embeddingsRerankers, bellmanGridworld, monteCarloGridworld, stochasticApproxSgd, findingCodeToChange, dddAnd3a, mineru, llamaCpp].sort((a, b) => b.date.localeCompare(a.date))
