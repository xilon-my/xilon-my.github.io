...
const projects = [multica, symphony, okf, openaiAgentsPython, pi, mcp, superpowersOpenspec, langgraph, embodiedAi, vla, rag, embeddingsRerankers, findingCodeToChange, dddAnd3a, mineru, llamaCpp].sort((a, b) => b.date.localeCompare(a.date))
